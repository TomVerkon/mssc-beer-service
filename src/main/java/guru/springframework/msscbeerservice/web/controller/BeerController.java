...
public class BeerController {
    ...
    @PutMapping("/{upc}")
    public ResponseEntity<BeerDto> updateBeerByUpc(@PathVariable("upc") String upc, @RequestBody @Validated BeerDto beerDto) {
	return new ResponseEntity<>(beerService.updateBeer(upc, beerDto), HttpStatus.NO_CONTENT);
    }
